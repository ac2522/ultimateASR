"""Tests for ultimate_asr.audio.vad - Silero VAD integration."""

import pytest

from ultimate_asr.audio.vad import AGGRESSIVENESS_TO_THRESHOLD, aggressiveness_to_threshold
...
from ultimate_asr.audio.vad import SILERO_MODEL_URL, ensure_vad_model
...
class TestEnsureVADModel:
    def test_skips_download_if_file_exists(self, tmp_path):
        ...
        with patch("ultimate_asr.audio.vad.urllib.request.urlretrieve") as urlretrieve:
    ...
    def test_downloads_to_partial_then_renames(self, tmp_path):
        ...
        with patch("ultimate_asr.audio.vad.urllib.request.urlretrieve", side_effect=fake_retrieve) as urlretrieve:
    ...
    def test_creates_parent_directory(self, tmp_path):
        ...
        with patch("ultimate_asr.audio.vad.urllib.request.urlretrieve", side_effect=fake_retrieve):
    ...
    def test_cleans_up_partial_on_failure(self, tmp_path):
        ...
        with patch("ultimate_asr.audio.vad.urllib.request.urlretrieve", side_effect=failing_retrieve):
...
from ultimate_asr.audio.vad import SileroVAD
...
def mock_onnx_session():
    ...
    # Patched at the source module because ultimate_asr.audio.vad now imports
