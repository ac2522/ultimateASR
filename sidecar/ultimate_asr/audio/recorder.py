...
from ultimate_asr.audio.vad import SileroVAD, aggressiveness_to_threshold, ensure_vad_model
from ultimate_asr.paths import vad_dir

logger = logging.getLogger(__name__)

# Location of the Silero VAD model on disk. Downloaded on first use.
VAD_MODEL_PATH = str(vad_dir() / "silero_vad.onnx")
...
class Recorder:
    ...
    def record_silence_mode(
        ...
        (see ultimate_asr.audio.vad.AGGRESSIVENESS_TO_THRESHOLD).
        """
