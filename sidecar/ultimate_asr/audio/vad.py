...
# Default on-disk location for the Silero VAD ONNX model. Uses the
# OS-aware data directory provided by ``ultimate_asr.paths.vad_dir``.
DEFAULT_VAD_MODEL_PATH = str(vad_dir() / "silero_vad.onnx")
